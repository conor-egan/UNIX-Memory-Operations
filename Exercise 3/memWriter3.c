...
Open a text file specified by the user. Map it to memory, modify the first character in the file, then close file.
Output execution time of program to user.
...
int main (int argc, char *argv[])
{
  ...
  //Display execution time to user
